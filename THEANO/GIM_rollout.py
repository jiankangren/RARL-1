#with agent2 output limit as input
import numpy as np
from rllab.misc import tensor_utils
import time
from rllab.misc import logger

def rarl_rollout(env, agent1, agent2, policy_num, action2_limit, max_path_length=np.inf, animated=False, speedup=1,
    ...
    while path_length < max_path_length:
        ...
        Action['action2_limit'] = action2_limit
