...
def _worker_collect_one_path(G, player1_avg, player2_avg, policy_num, action2_limit, max_path_length, scope=None):
    G = _get_scoped_G(G, scope)
    agent1 = G.policy1
    agent2 = G.policy2
    if player1_avg:
...
def sample_paths(
    ...
    return singleton_pool.run_collect(
        ...
        args=(player1_avg, player2_avg, policy_num, action2_limit, max_path_length, scope),
        show_prog_bar=True
    )
