...
class GaussianLSTMRARLPolicy(StochasticPolicy, LayersPowered, Serializable):
    def __init__(
            self,
            name,
            env_spec,
        ...
        with tf.variable_scope(name):
            ...
            super(GaussianLSTMRARLPolicy, self).__init__(env_spec)

            if obs_dim_override is None:
